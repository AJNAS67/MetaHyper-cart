...
(function () {
  ...
  let MenCount = document.getElementById("MenCount").innerHTML;
  console.log(MenCount, "MenCountMenCount");
  let WomenCount = document.getElementById("WomenCount").innerHTML;
  console.log(WomenCount, "WomenCount");
  let AccessoriesCount = document.getElementById("AccessoriesCount").innerHTML;
  console.log(AccessoriesCount, "AccessoriesCount");
  let KidsCount = document.getElementById("KidsCount").innerHTML;
  ...
  const totalRevenueChartEl = document.querySelector("#totalRevenueChart"),
    totalRevenueChartOptions = {
      ...
      xaxis: {
        categories: ["Men", "Women", "Kids", "Cosmetic", "Accessorie"],
        labels: {
          style: {
            fontSize: "13px",
            colors: axisColor,
